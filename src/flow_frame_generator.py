...
npy_folder = 'F:/AAAAAAAAAA/bitirme_npy_images/npy' # 'train_npy/npy3', 'test_npy/npy3'
out_folder = 'F:/AAAAAAAAAA/bitirme_npy_images/images' # 'train_flow_depth', 'test_flow_depth', 'train_flow_color', 'val_flow_color', 'test_flow_color' 
